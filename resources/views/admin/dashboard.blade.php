        ...
        <a href="{{route('conversion.view')}}">
            <div class="stats-card">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        <h3>{{$approved_conversion}}</h3>
                        <h6 class="text-muted mb-0">Approved Conversions</h6>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="{{route('conversion.view')}}">
            <div class="stats-card">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        <h3>{{$pending_conversion}}</h3>
                        <h6 class="text-muted mb-0">Pending Conversions</h6>
                    </div>
                </div>
            </div>
        </a>
        ...
        <a href="{{route('conversion.view')}}">
            <div class="stats-card">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        <h3>{{$reject_conversion}}</h3>
                        <h6 class="text-muted mb-0">Rejected Conversions</h6>
                    </div>
                </div>
            </div>
        </a>
            ...
            <div class="stats-card">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        ...
                        <h6 class="text-muted mb-0">Withdrawal Rejected Request</h6>
                    </div>
                </div>
            </div>
        </a>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="chart-container">
            <x-high-chart
                ...
                series-name="Campaigns"
                :categories="['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']"
                :series="$campaign_totalSeries"
                :pending-series="$campaign_pendingSeries"
                :approved-series="$campaign_approvedSeries"
                :rejected-series="$campaign_rejectedSeries"
    ...
    <div class="col-lg-6">
        <div class="chart-container">
            <x-high-chart
                chart-id="conversion_chart"
                chart-type="area"
                title="Conversion Data"
                subtitle="Conversion Analytics"
                series-name="Total"
                :categories="['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']"
                :series="$conversion_totalSeries"
                :pending-series="$conversion_pendingSeries"
                :approved-series="$conversion_approvedSeries"
                :rejected-series="$conversion_rejectedSeries"
            />
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="chart-container">
            <x-high-chart
                chart-id="ticket-chart"
                chart-type="column"
                title="Ticket Data"
                subtitle="Ticket Analytics"
                series-name="Ticket"
                :categories="['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']"
                :series="$ticket_totalSeries"
                :pending-series="$ticket_pendingSeries"
                :approved-series="$ticket_approvedSeries"
                :rejected-series="$ticket_rejectedSeries"
