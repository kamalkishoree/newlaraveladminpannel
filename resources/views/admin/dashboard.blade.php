			...
			<div class="row justify-content-between align-content-between" style="height: 100%;">
				...
				<div class="col-md-6">
					 <div class="create-btn pull-right d-flex align-items-center">
                        ...
                        <div class="dropdown">
                            <button type="button" class="btn custom-create-btn btn_days dropdown-toggle" data-toggle="dropdown">
						...
						<a href="{{ route('users.create') }}" class="btn custom-create-btn ml-2 btn_days"> <i class="fa fa-share mr-2" aria-hidden="true"></i> Export</a>
					</div>
				</div>
			</div>
		</div><!-- /card finish -->	
