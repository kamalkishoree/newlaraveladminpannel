    ...
    <form action="{{ route('coupon.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="page-header">
            <div class="card breadcrumb-card">
                ...
                <div class="col-md-6">
                        <h3 class="page-title">{{__('CREATE COUPON')}}</h3>
                        <ul class="breadcrumb">
                        ...
                        <div class="card-header">
                          ...
                          <div class="card-body">
                            ...
                            <div class="form-group d-none">
                                <label for="clocking_url" class="">{{ __('CLOCKING URL') }}:</label>
                                <input type="text" name="clocking_url" id="clocking_url" class="form-control @error('clocking_url') form-control-error @enderror"   value="{{ old('clocking_url') }}">
                                @error('clocking_url')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <x-ckeditor name="description" id="description" label="OTHER DETAILS"  />
                            @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
