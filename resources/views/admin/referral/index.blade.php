...
@section('content')
	...
	<div class="page-header">
		<div class="card breadcrumb-card">
			<div class="row justify-content-between align-content-between" style="height: 100%;">
				<div class="col-md-6">
					<h3 class="page-title">{{__('Referral Request')}}</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="{{ route('dashboard') }}">Dashboard</a>
						</li>
						<li class="breadcrumb-item active-breadcrumb">
							<a href="{{ route('referral.index') }}">{{ __('Referral') }}</a>
						</li>
					</ul>
				</div>
			</div>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form  action="{{ route('referral.index') }}" method="GET" enctype="multipart/form-data" >
            <div class="card-body">
                    ...
                    <table class="table table-hover table-center mb-0" id="table">
                        <thead>
                            <tr>
                                ...
                                <th class="">{{ __('Referral By') }}</th>
                                <th class="">{{ __('Refered To') }}</th>
                                <th class="">{{ __('Referral Amount') }}</th>
...
@push('scripts')
        ...
        $(function() {
            $('#table').DataTable({
                ...
                columns: [
                    ...
                    {  data: 'refered_to', name: 'refered_to' },
    ...
    <script type="text/javascript">
        function changeStatus(_this, id) {
            ...
            $.ajax({
                url: `{{ route('referral.change-status') }}`,
                type: 'GET',
                data: {
                    _token: _token,
                    id: id,
