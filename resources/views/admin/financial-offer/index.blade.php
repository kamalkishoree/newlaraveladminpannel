...
@section('content')
	...
	<div class="page-header">
		<div class="card breadcrumb-card">
			<div class="row justify-content-between align-content-between" style="height: 100%;">
				<div class="col-md-6">
					<h3 class="page-title">{{__('Financial Offer Details')}}</h3>
					<ul class="breadcrumb">
						<li class="breadcrumb-item">
							<a href="{{ route('dashboard') }}">Dashboard</a>
						</li>
						<li class="breadcrumb-item active-breadcrumb">
							<a href="{{ route('financial-offer.index') }}">{{ __('Financial Offer') }}</a>
						</li>
					</ul>
				</div>
                    <div class="col-md-3">
                        <div class="create-btn pull-right">
                            <a href="{{ route('financial-offer.create') }}" class="btn custom-create-btn">{{ __('Add New Financial Offer') }}</a>
                        </div>                 
                    </div>
			</div>
		</div><!-- /card finish -->	
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form  action="{{ route('financial-offer.index') }}" method="GET" enctype="multipart/form-data" >
            <div class="card-body">
...
@push('scripts')
    <script>
        $(function() {
            $('#table').DataTable({
                ...
                ajax: {
                url:"{{ route('financial-offer.index') }}",
                type: "GET",
                data: function(d) {
    ...
    <script type="text/javascript">
        function changeUserStatus(_this, id) {
            ...
            $.ajax({
                url: `{{ route('financial-offer.status_update') }}`,
                type: 'GET',
                data: {
                    _token: _token,
                    id: id,
