...
@section('content')
    <form action="{{ route('financial-offer.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="page-header">
            <div class="card breadcrumb-card">
                <div class="row justify-content-between align-content-between" style="height: 100%;">
                    <div class="col-md-6">
                        <h3 class="page-title">{{__('Create Financial Offer')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{ route('financial-offer.index') }}">{{ __('Financial Offer') }}</a></li>
                            <li class="breadcrumb-item active-breadcrumb"><a
                                    href="{{ route('financial-offer.create') }}">{{ __('Add new Financial Offer') }}</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
