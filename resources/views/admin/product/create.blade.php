        ...
        <div class="page-header">
            <div class="card breadcrumb-card">
                <div class="row justify-content-between align-content-between" style="height: 100%;">
                    <div class="col-md-6">
                        <h3 class="page-title">{{__('Create Product')}}</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{ route('product.index') }}">{{ __('Product') }}</a></li>
                            <li class="breadcrumb-item active-breadcrumb"><a
                                    href="{{ route('product.create') }}">{{ __('Add new Product') }}</a></li>
                        </ul>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="target_url" id="slug" class="form-control @error('target_url') form-control-error @enderror"  required="required" value="{{ old('target_url') }}">
                            ...
                            <div class="form-group">
                                <label for="brand_id" class="required">{{ __('Categroy') }}:</label>
