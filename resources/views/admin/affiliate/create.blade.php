							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<input type="text" name="provider_name" id="provider_name" class="form-control @error('provider_name') form-control-error @enderror" required="required" value="{{old('provider_name')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="client_id" id="client_id" class="form-control @error('client_id') form-control-error @enderror"  value="{{old('client_id')}}">
                                            @error('client_id')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
									</div>
									...
									<div class="form-group">
                                        ...
                                        <input type="text" name="client_secret" id="client_secret" class="form-control @error('client_secret') form-control-error @enderror"  value="{{old('client_secret')}}">
										@error('client_secret')
											<span class="text-danger">{{ $message }}</span>
										@enderror
									</div>
